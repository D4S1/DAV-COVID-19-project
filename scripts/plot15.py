...
"""
def main():
	args = parse_args("plot15")
	if args:

		col_name= 'daily_vaccinations'
		ylabel='Daily number of vaccinations'
		ptitle='Daily number of vaccinations'
	...
	#			ax.set_xticks(years_idx,use_names,size=15)
				...
				t=ax.text(dates[-200], yval[-3] ,f"{xs[frame]}", size=25, va="center", ha="left",)
