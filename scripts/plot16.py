...
"""
def main():
	args = parse_args("plot16")
	if args:

		col_name= 'daily_people_vaccinated'
		ylabel='Daily number of people vaccinated'
		ptitle='Daily number of people vaccinated'
		...
		if args[1]<3 :
			...
			for i in range(5):
				yval.append(i*50*1e3)
				if i:
					ylab.append(f"{i*50}k")
